                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input data-placement="bottomRight" name="icon" value="{{ old('icon') }}" class="form-control icp icp-auto" value="fas fa-archive" type="text" placeholder="Enter Icon">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="order_by" id="order_by" value="{{ old('order_by') }}" class="form-control" placeholder="Enter order">
                                                </div>
                                            </div>
